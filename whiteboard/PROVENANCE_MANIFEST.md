...
- `brand`: PatchworkMD
- `canonical_source`: private local skill hub → portability-rewritten 2026-08-06 for public export
...
- `license_decision`: MIT (cleared by the repository maintainer on 2026-08-06)
